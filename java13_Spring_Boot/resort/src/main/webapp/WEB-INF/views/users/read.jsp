...
<body>
  ...
  <FORM name='frm' id='frm' method='POST' action='./update' 
              onsubmit="return send();" class="form-horizontal">
    <input type='hidden' name='usersno' id='usersno' value='${usersVO.usersno }'>          
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='name' id='name' 
                   value='${usersVO.name }' required="required" style='width: 30%;' placeholder="성명">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='tel' id='tel' 
                   value='${usersVO.tel }' required="required" style='width: 30%;' placeholder="전화번호"> 예) 010-0000-0000
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='zipcode' id='zipcode' 
                   value='${usersVO.zipcode }' required="required" style='width: 30%;' placeholder="우편번호">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='address1' id='address1' 
                   value='${usersVO.address1 }' required="required" style='width: 80%;' placeholder="주소">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='address2' id='address2' 
                   value='${usersVO.address2 }' required="required" style='width: 80%;' placeholder="상세 주소">
      </div>
    </div>   
