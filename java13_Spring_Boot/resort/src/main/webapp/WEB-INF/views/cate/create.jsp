...
<FORM name='frm' method='POST' action='./create' class="form-horizontal">
  <!-- 
  부모테이블 categrpno PK 컬럼 값 이용
  http://localhost:8000/cate/create?categrpno=4
   -->
  ...
  <div class="content_bottom_menu" style="padding-right: 20%;">
    ...
    <button type="button" onclick="location.href='./list'" class="btn btn-primary">목록</button>
  </div>
