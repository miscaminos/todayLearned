...
<body>
  ...
  <DIV class='title_line'><A href="../categrp/list.do">카테고리 그룹</A> > 전체 카테고리</DIV>
  ...
  <TABLE class='table table-striped'>
    ...
    <c:forEach var="cateVO" items="${list }">  <!-- request 객체에 접근 -->
      ...
      <TR>
        ...
        <TD class="td_bs">
          <A href="./read_update?cateno=${cateno }"><span class="glyphicon glyphicon-pencil"></span></A>
          <A href="./read_delete?cateno=${cateno }"><span class="glyphicon glyphicon-trash"></span></A>
          <A href="./update_seqno_up?cateno=${cateno }"><span class="glyphicon glyphicon-arrow-up"></span></A>
          <A href="./update_seqno_down?cateno=${cateno }"><span class="glyphicon glyphicon-arrow-down"></span></A>         
        </TD>             
      </TR>
    </c:forEach>
    </tbody>
