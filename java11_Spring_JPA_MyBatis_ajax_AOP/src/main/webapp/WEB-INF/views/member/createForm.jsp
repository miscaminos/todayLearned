...
<head>
  ...
  <!-- web상에 제공자가 올려둔 source code를 access할 수 있게 해두었기대문에 아래와같이 -->
  <!-- src="http://blahblahblah.js"로 연결해두면 됨. -->
  <!-- 그리고 sample6_execDaumPostcode()도 제공해준대로 복사해넣음. -->
  <!-- function안에 id로 구분된 각 tag들은 페이지내 원하는 위치에 놓고 id로 연결함. -->
...
<label class="col-sm-offset-2 col-sm-10">(<span id="need">*</span> 필수입력사항)</label>
  <form class="form-horizontal" 
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">          
        <input type="text" class="form-control" id="mname" placeholder="Enter 이름"  name="mname">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="tel"><span id="need">*</span>전화번호</label>
      <div class="col-sm-4">          
        <input type="text" class="form-control" id="tel" placeholder="Enter 전화번호"  name="tel">
      </div>
    </div>
    <div class="form-group">
