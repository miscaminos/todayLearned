...
<script type="text/javascript">
    function updateM(){
      ...
      //?앞에까지가 URL이다.그 다음은 parameter. 
      //URL안에 bbsno와 oldfilename을 넣고 CONTROLLER를 호출함. 
      //(MVC 패턴에서는 항상 요청 들어오면 controller 호출한다는것을 기억하자.)
...
<!-- 페이지 로딩시 댓글 목록 처리-->
 ...
 <!-- javascript로 만들어져있는 .js 파일 안에서는 el표기가 잘 인식되지않음. 그래서 var에 넣어저 사용 -->
  <script type="text/javascript">
  var bbsno = "${dto.bbsno}";
  var sno = "${sno}";
  var eno = "${eno}";
