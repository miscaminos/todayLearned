...
<h1 class="col-sm-offset-2 col-sm-10">로그인</h1>
  <form class="form-horizontal" 
        action="login"
        method="post">
    <!-- 메뉴에서 바로 로그인할 경우에는 param 비어있지만, 댓글을 달려다가 로그인하는 경우에는 param에 값들이 있음 -->
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-6">
        <div class="checkbox">
         ...
         <c:choose>
           <c:when test="${c_id == 'Y'}">
           <input type="checkbox" name="c_id" value="Y" checked="checked"> Remember ID </c:when>
           <c:otherwise>
           <input type="checkbox" name="c_id" value="Y" > Remember ID </c:otherwise>
         </c:choose>
         </label>
        </div>
      </div>
